...
The Basement is a room. "[if the player is in the basement of the first time] A huge basement that gives off some bad vibes. It seems like the most unlikely escape from this prison, but there must be some clues around. The first thing you notice is large steel cage, its door swong wide open.[endif] The cage rests in a corner. You can also see a damaged old painting on the wall, some old boxes[unless the player has pushed the boxes]from which a hint of moonlight seems to be peering in[endif], and a table with various medical utilities."
